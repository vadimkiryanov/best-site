...
function App() {
  return (
    <>
      ...
      <main className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-10 min-h-full flex-1">
        <div className="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
          <div className="lg:col-span-3">
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl dark:text-white">Мутим крутые проекты</h1>
            <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">Представляем вашему бренду новый способ привлечь внимание творческого сообщества.</p>
            ...
            <div className="mt-5 lg:mt-8 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
              <div className="w-full sm:w-auto">
                ...
                <input
                  ...
                  id="hero-input"
                  name="hero-input"
                  className="py-3 px-4 block w-full xl:min-w-[18rem] border-gray-200 shadow-sm rounded-md focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-800 dark:border-gray-700 dark:text-gray-400"
          ...
          <div className="lg:col-span-4 mt-10 lg:mt-0">
            <img
              ...
              src="https://clipart-library.com/newhp/Moon_Transparent_PNG_Clip_Art-639687983.png"
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-800 dark:border-gray-700">
              <div className="flex items-center gap-x-4">
                <img
                  ...
                  src="https://cdn.ayo.so/1ec5165900232aacb990f3549cfd93667cbb952832aa5db1.webp"
                  alt="Image Description"
                />
                <div className="grow">
                  <h3 className="font-medium text-gray-800 dark:text-gray-200">Mei Feng</h3>
                  <p className="text-xs uppercase text-gray-500">DevOps</p>
                </div>
              </div>

              <p className="mt-3 text-gray-500">Hey, im yuyux9/yuyu. CTF player from 893crew aka 89cr3w. Working as DevOps-engineer.</p>
            ...
            <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-800 dark:border-gray-700">
              <div className="flex items-center gap-x-4">
                <img className="rounded-full w-20 h-20" src="/bgmain.jpg" alt="Image Description" />
                <div className="grow">
                  <h3 className="font-medium text-gray-800 dark:text-gray-200">Jenkins</h3>
                  <p className="text-xs uppercase text-gray-500">Frontend developer</p>
                </div>
              </div>

              <p className="mt-3 text-gray-500">I really like JQuery</p>
            ...
            <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-800 dark:border-gray-700">
              <div className="flex items-center gap-x-4">
                <img className="rounded-full w-20 h-20" src="/andre.jpg" alt="Image Description" />
                <div className="grow">
                  <h3 className="font-medium text-gray-800 dark:text-gray-200">Andre Chelentano</h3>
                  <p className="text-xs uppercase text-gray-500">launcher developer</p>
                </div>
              </div>

              <p className="mt-3 text-gray-500">I really like italian food.</p>
            ...
            <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-800 dark:border-gray-700">
              <div className="flex items-center gap-x-4">
                <img
                  className="rounded-full w-20 h-20"
                  src="https://captainfunko.ru/image/cache/catalog/FUNKO%20POP%20VINYL/F50965/funko-pop-transformers-optimus-prime%20(1)-1000x1000.jpg"
                  alt="Image Description"
                />
                <div className="grow">
                  <h3 className="font-medium text-gray-800 dark:text-gray-200">Optimus Prime</h3>
                  <p className="text-xs uppercase text-gray-500">Terminator 3000</p>
                </div>
              </div>

              <p className="mt-3 text-gray-500">I can all.</p>
