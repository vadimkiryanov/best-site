    ...
    <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <img src="https://clipart-library.com/newhp/Moon_Transparent_PNG_Clip_Art-639687983.png" alt="" className="object-cover rounded-full w-20 p-2" />
          <h3 className="font-bold"> Moonlight Eclipse Dev</h3>
          {/* </a> */}
          <div className="md:hidden">
            <button
              type="button"
              className="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-2 rounded-full border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-800 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800"
